...
int main(int argc, char** argv)
{
    ...
    Buffer<uint8_t> input = load<uint8_t>("images/rgb.png");
    ...
    //// SUM ONLY
    {
        ...
        Buffer<float> output = mySum.realize({input.channels()});
    ...
    //// AVERAGE
    {
        ...
        // We now call realize() to compile and execute.
        Buffer<float> output = myAverage.realize({input.channels()});
    ...
    // average across the three channels
    {
        ...
        Buffer<float> output = avAcrossChannel.realize();
